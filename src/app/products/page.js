...
export default function ProductList() {
  ...
  const handleInputChange = (e) => {
    ...
    // If the input is for price, convert the value to an integer
    const updatedValue = name === "price" ? parseInt(value, 10) || 0 : value;
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // Update the list of products if successful
      setIsOpen(false);
