export default function About() {
  return (
    <div className="">
      ...
      understand that shopping should be easy, enjoyable, and reliable—that’s
      why we’ve built an online store designed to meet your needs and exceed
      your expectations. At [YourWebsiteName], we carefully select each item in
      our collection to ensure we offer a variety of high-quality products
      across all categories. From the latest trends in fashion and electronics
      to must-have essentials for home and living, we strive to cater to every
      taste and lifestyle. Our commitment to excellence goes beyond our
